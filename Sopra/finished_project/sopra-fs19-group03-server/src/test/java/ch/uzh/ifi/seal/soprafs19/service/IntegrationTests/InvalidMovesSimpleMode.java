...
public class InvalidMovesSimpleMode {
    @Autowired
    ...
    public void placeOutsidePlayField() {
    ...
    public void placeWorkerOnOtherWorkersField() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
    ...
    @Test(expected = InvalidMoveException.class)
    public void placeBuildingOnWorker() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
    ...
    @Test(expected = InvalidMoveException.class)
    public void placeCupolaOnLevel0() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
        ...
        move6.setRow(1);
        move6.setColumn(0);
        move6.setType(ObjectType.CUPOLA);
        move6.setSkip(false);
        MoveMessage moveMessage6 = new MoveMessage();
        moveMessage6.setAuthorization(authorizationCredentialsPlayer1);
        moveMessage6.setMove(move6);
