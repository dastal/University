...
public class GodCardApolloTest {
    ...
    public void moveInSimpleMode() {
        ...
        //deciding move is not valid in without GodCard
        Move move5 = new Move();
        move5.setRow(3);
        move5.setColumn(2);
    ...
    @Test
    public void moveWithApolloCard() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
        ...
        cardCollection.add(GameCard.APOLLO);
        cardCollection.add(GameCard.APOLLO);
        ...
        cardMessage1.setChosenCard(GameCard.APOLLO);

        GameCardMessage cardMessage2 = new GameCardMessage();
        cardMessage2.setUserId(pickList.next());
        cardMessage2.setChosenCard(GameCard.APOLLO);
        ...
        //deciding move: Set worker1 of player1 to the field of worker1 of player2
        Move move5 = new Move();
        move5.setRow(3);
        move5.setColumn(2);
        move5.setType(ObjectType.WORKER1);
