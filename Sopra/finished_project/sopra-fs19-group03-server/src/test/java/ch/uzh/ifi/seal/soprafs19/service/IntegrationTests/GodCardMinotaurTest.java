...
public class GodCardMinotaurTest {
    ...
    public void moveInSimpleMode() {
        ...
        //Deciding Move: Push enemy back on the same Level
        Move move5 = new Move();
        move5.setRow(3);
        move5.setColumn(2);
        move5.setType(ObjectType.WORKER2);
        move5.setSkip(false);
    ...
    @Test
    public void pushBackWithGodCardMinotaurSameLevel() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
        ...
        cardCollection.add(GameCard.MINOTAUR);
        cardCollection.add(GameCard.MINOTAUR);
        ...
        cardMessage1.setChosenCard(GameCard.MINOTAUR);

        GameCardMessage cardMessage2 = new GameCardMessage();
        cardMessage2.setUserId(pickList.next());
        cardMessage2.setChosenCard(GameCard.MINOTAUR);
    ...
    @Test
    public void pushBackWithGodCardMinotaurDifferentLevel() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
        ...
        //deciding Move: Push enemy back one level higher
        Move move9 = new Move();
        move9.setRow(2);
        move9.setColumn(2);
    ...
    @Test(expected = InvalidMoveException.class)
    public void PushEnemyBackInvalid() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
