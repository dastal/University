...
public class GodCardPrometheusTest {
    ...
    public void moveInSimpleMode() {
        ...
        //deciding move: Build before moving Worker
        Move move9 = new Move();
        move9.setRow(3);
        move9.setColumn(0);
    ...
    @Test
    public void buildBeforeAndAfterMoveWithGodCardPrometheus() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
        ...
        cardCollection.add(GameCard.PROMETHEUS);
        cardCollection.add(GameCard.PROMETHEUS);
        ...
        cardMessage1.setChosenCard(GameCard.PROMETHEUS);

        GameCardMessage cardMessage2 = new GameCardMessage();
        cardMessage2.setUserId(pickList.next());
        cardMessage2.setChosenCard(GameCard.PROMETHEUS);
        ...
        Move move05 = new Move();
        move05.setRow(1);
        move05.setColumn(1);
        move05.setType(ObjectType.BUILDING);
        move05.setSkip(false);
        MoveMessage moveMessage05 = new MoveMessage();
        moveMessage05.setAuthorization(authorizationCredentialsPlayer1);
        moveMessage05.setMove(move05);
        lobbyService.wrapAndUpdate(tesLobbyToken, moveMessage05);
        testLobbyContext = lobbyService.getLobbyContext(tesLobbyToken);
    ...
    @Test(expected = InvalidMoveException.class)
    public void demeterNeedsToBuildTwice() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
        ...
        GameCardMessage cardMessage1 = new GameCardMessage();
        cardMessage1.setUserId(pickList.next());
        cardMessage1.setChosenCard(GameCard.DEMETER);
        ...
        //now he can't move a level up
        Move move10 = new Move();
        move10.setRow(3);
        move10.setColumn(0);
        move10.setType(ObjectType.WORKER1);
