...
public class GodCardAthenaTest {
    ...
    public void moveInSimpleMode() {
        ...
        //deciding move: when the worker of the player moves up, in the next step the workers of the other player are not allowed to move up
        Move move9 = new Move();
        move9.setRow(2);
        move9.setColumn(1);
    ...
    public void InvalidMoveAfterAthenaCard() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
        ...
        cardCollection.add(GameCard.ATHENA);
        cardCollection.add(GameCard.ATHENA);
        ...
        cardMessage1.setChosenCard(GameCard.ATHENA);

        GameCardMessage cardMessage2 = new GameCardMessage();
        cardMessage2.setUserId(pickList.next());
        cardMessage2.setChosenCard(GameCard.ATHENA);
