...
public class GodCardHermesTest {
    ...
    public void moveInSimpleMode() {
        ...
        //deciding move: hermes may run more than one field with one worker
        Move move6 = new Move();
        move6.setRow(0);
        move6.setColumn(1);
    ...
    @Test
    public void runMoreThanOneFieldWithHermes() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
        ...
        cardCollection.add(GameCard.HERMES);
        cardCollection.add(GameCard.HERMES);
        ...
        cardMessage1.setChosenCard(GameCard.HERMES);

        GameCardMessage cardMessage2 = new GameCardMessage();
        cardMessage2.setUserId(pickList.next());
        cardMessage2.setChosenCard(GameCard.HERMES);
