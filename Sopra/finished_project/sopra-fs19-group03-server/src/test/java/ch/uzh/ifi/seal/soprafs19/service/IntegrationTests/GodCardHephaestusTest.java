...
public class GodCardHephaestusTest {
    ...
    public void moveInSimpleMode() {
        ...
        move61.setRow(1);
        move61.setColumn(2);
        move61.setType(ObjectType.BUILDING);
        move61.setSkip(false);
        MoveMessage moveMessage61 = new MoveMessage();
        moveMessage61.setAuthorization(authorizationCredentialsPlayer1);
        moveMessage61.setMove(move61);
        lobbyService.wrapAndUpdate(tesLobbyToken, moveMessage61);
        testLobbyContext = lobbyService.getLobbyContext(tesLobbyToken);

        Move move7 = new Move();
        move7.setRow(4);
        move7.setColumn(2);
        move7.setType(ObjectType.WORKER2);
        move7.setSkip(false);
        ...
        //deciding move: Hephaestus may build a second block on top of his first in the same Move
        Move move9 = new Move();
        move9.setRow(4);
        move9.setColumn(3);
        move9.setType(ObjectType.BUILDING);
        move9.setSkip(false);
        MoveMessage moveMessage9 = new MoveMessage();
        moveMessage9.setAuthorization(authorizationCredentialsPlayer2);
    ...
    @Test
    public void buildASecondBlockOnTopOfTheFirstWithHephaestus() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
        ...
        cardCollection.add(GameCard.HEPHAESTUS);
        cardCollection.add(GameCard.HEPHAESTUS);
        ...
        cardMessage1.setChosenCard(GameCard.HEPHAESTUS);

        GameCardMessage cardMessage2 = new GameCardMessage();
        cardMessage2.setUserId(pickList.next());
        cardMessage2.setChosenCard(GameCard.HEPHAESTUS);
    ...
    @Test(expected = InvalidMoveException.class)
    public void buildASecondBlockAnywhereElseWithHephaestus() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
