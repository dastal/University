...
public class GodCardAtlasTest {
    ...
    public void moveInSimpleMode() {
        ...
        //deciding move: Atlas can build a Cupola on any level (here: level1)
        Move move10 = new Move();
        move10.setRow(1);
        move10.setColumn(1);
        move10.setType(ObjectType.CUPOLA);
    ...
    @Test
    public void buildWithAtlasCard() {
        gameRepository.deleteAll();
        lobbyStateRepository.deleteAll();
        rulesetRepository.deleteAll();
        lobbyContextRepository.deleteAll();
        ...
        cardMessage2.setChosenCard(GameCard.ATLAS);
