...
extern void F960_7111(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {FO_FILE}.make */
void F960_7111 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(4939, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 4946, 0xF80000E7, 0); /* content */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 1, 0, 13400);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (EIF_INTEGER_32) (EIF_INTEGER_32) ((EIF_INTEGER_32) (((EIF_INTEGER_32) 5L) * ti4_1) + loc1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
