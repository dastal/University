...
static const EIF_TYPE_INDEX egt_0_20 [] = {0xFF01,231,0xFFFF};
static const EIF_TYPE_INDEX egt_1_20 [] = {0xFF01,246,19,0xFFFF};
...
static const EIF_TYPE_INDEX egt_9_20 [] = {0xFF01,231,0xFFFF};
static const EIF_TYPE_INDEX egt_10_20 [] = {0xFF01,231,0xFFFF};
...
static const struct desc_info desc_20[] = {
	...
	{EIF_NON_GENERIC(0x01A7 /*211*/), 354, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 355, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 356, 0xFFFFFFFF},
};
void Init20(void)
{
	IDSC(desc_20, 0, 19);
	IDSC(desc_20 + 1, 1, 19);
	IDSC(desc_20 + 32, 132, 19);
}
