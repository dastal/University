...
extern EIF_TYPED_VALUE F698_3216(EIF_REFERENCE);
extern EIF_TYPED_VALUE F698_3219(EIF_REFERENCE);
extern void F698_7061(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F698_3216 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 697, Current, 0, 0, 4838);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(697, Current, 4838);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F698_3219 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 697, Current, 0, 0, 4840);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(697, Current, 4840);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F698_7061 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 697, Current, 0, 7060);
	RTSA(dtype);
	RTME(dtype, 0);
