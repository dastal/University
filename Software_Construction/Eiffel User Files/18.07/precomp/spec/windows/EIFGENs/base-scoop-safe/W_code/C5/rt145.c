...
extern EIF_TYPED_VALUE F145_2951(EIF_REFERENCE);
extern EIF_TYPED_VALUE F145_2952(EIF_REFERENCE);
extern EIF_TYPED_VALUE F145_2953(EIF_REFERENCE);
extern EIF_TYPED_VALUE F145_2955(EIF_REFERENCE);
extern void F145_2960(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F145_2951 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F145_2952 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F145_2953 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F145_2955 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 144, Current, 0, 0, 3045);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(144, Current, 3045);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F145_2960 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 144, Current, 0, 1, 3046);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(144, Current, 3046);
	RTCC(arg1, 144, l_feature_name, 1, RTWCT(2455, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 2455, 0xF80000B9, 0); /* breakable_info */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(2455, Dtype(Current))) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
