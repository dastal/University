...
EIF_TYPED_VALUE F99_1507 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 98, Current, 0, 0, 1443);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(811, 30))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 98, Current, 0, 0, 1444);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
