...
extern EIF_TYPED_VALUE F359_3121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F359_3121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 358, Current, 0, 0, 3880);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(358, Current, 3880);
	RTIV(Current, RTAL);
