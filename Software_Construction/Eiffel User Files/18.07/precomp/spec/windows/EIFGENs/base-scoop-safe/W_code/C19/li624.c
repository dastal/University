...
extern EIF_TYPED_VALUE F624_3402(EIF_REFERENCE);
extern void F624_7066(EIF_REFERENCE, int);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 623, Current, 2, 1, 6128);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(623, Current, 6128);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1771, "item", arg1))(arg1)).it_n4);
...
EIF_TYPED_VALUE F624_3401 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 623, Current, 0, 0, 6129);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(623, Current, 6129);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F624_3402 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 623, Current, 0, 0, 6130);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(623, Current, 6130);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F624_7066 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 623, Current, 0, 7065);
	RTSA(dtype);
	RTME(dtype, 0);
