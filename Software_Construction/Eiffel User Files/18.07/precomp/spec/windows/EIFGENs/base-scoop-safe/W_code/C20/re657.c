...
extern EIF_TYPED_VALUE F657_3216(EIF_REFERENCE);
extern EIF_TYPED_VALUE F657_3219(EIF_REFERENCE);
extern void F657_7061(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F657_3216 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 656, Current, 0, 0, 4835);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(656, Current, 4835);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F657_3219 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 656, Current, 0, 0, 4837);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(656, Current, 4837);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F657_7061 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 656, Current, 0, 7060);
	RTSA(dtype);
	RTME(dtype, 0);
