...
extern EIF_TYPED_VALUE F144_2950(EIF_REFERENCE);
extern void F144_7055(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F144_2950 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 143, Current, 0, 0, 3040);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(143, Current, 3040);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F144_7055 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 143, Current, 0, 7054);
	RTSA(dtype);
	RTME(dtype, 0);
