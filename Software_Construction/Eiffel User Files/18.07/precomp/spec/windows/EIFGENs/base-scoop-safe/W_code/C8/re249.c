...
extern void F249_7061(EIF_REFERENCE, int);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 248, Current, 0, 0, 4808);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 248, Current, 0, 0, 4810);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F249_7061 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 248, Current, 0, 7060);
	RTSA(dtype);
	RTME(dtype, 0);
