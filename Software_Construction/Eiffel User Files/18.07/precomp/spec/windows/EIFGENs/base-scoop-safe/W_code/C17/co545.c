...
extern EIF_TYPED_VALUE F545_1940(EIF_REFERENCE);
extern EIF_TYPED_VALUE F545_1941(EIF_REFERENCE);
extern void F545_1942(EIF_REFERENCE);
extern void F545_1943(EIF_REFERENCE);
...
EIF_TYPED_VALUE F545_1939 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 544, Current, 0, 0, 1909);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(544, Current, 1909);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F545_1940 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F545_1941 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 544, Current, 0, 0, 1911);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(544, Current, 1911);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F545_1942 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 544, Current, 0, 0, 1912);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(544, Current, 1912);
	RTIV(Current, RTAL);
...
void F545_1943 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 544, Current, 0, 0, 1913);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(544, Current, 1913);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
