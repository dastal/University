...
extern EIF_TYPED_VALUE F734_3216(EIF_REFERENCE);
extern EIF_TYPED_VALUE F734_3219(EIF_REFERENCE);
extern void F734_7061(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F734_3216 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 733, Current, 0, 0, 4841);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(733, Current, 4841);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F734_3219 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 733, Current, 0, 0, 4843);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(733, Current, 4843);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F734_7061 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 733, Current, 0, 7060);
	RTSA(dtype);
	RTME(dtype, 0);
