...
extern void F606_7061(EIF_REFERENCE, int);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 605, Current, 0, 0, 4832);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(605, Current, 4832);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 605, Current, 0, 0, 4834);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(605, Current, 4834);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F606_7061 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 605, Current, 0, 7060);
	RTSA(dtype);
	RTME(dtype, 0);
