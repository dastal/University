...
extern EIF_TYPED_VALUE F765_2027(EIF_REFERENCE);
extern void F765_7038(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F765_2027 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 764, Current, 0, 0, 2112);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(764, Current, 2112);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F765_7038 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 764, Current, 0, 7037);
	RTSA(dtype);
	RTME(dtype, 0);
