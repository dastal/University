...
extern EIF_TYPED_VALUE F761_3385(EIF_REFERENCE);
extern EIF_TYPED_VALUE F761_3386(EIF_REFERENCE);
extern void F761_3392(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F761_3395(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F761_3396(EIF_REFERENCE);
extern EIF_TYPED_VALUE F761_3397(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F761_3385 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 760, Current, 0, 0, 6070);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(760, Current, 6070);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F761_3386 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 760, Current, 0, 0, 6071);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(760, Current, 6071);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F761_3392 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 760, Current, 0, 1, 6072);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(760, Current, 6072);
	RTIV(Current, RTAL);
...
void F761_3395 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 760, Current, 0, 1, 6073);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(760, Current, 6073);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F761_3396 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 760, Current, 0, 0, 6074);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(760, Current, 6074);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F761_3397 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 760, Current, 2, 1, 6075);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(760, Current, 6075);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ui2_1 = ti2_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1735, "extend", Result))(Result, ui2_1x);
		RTHOOK(9);
