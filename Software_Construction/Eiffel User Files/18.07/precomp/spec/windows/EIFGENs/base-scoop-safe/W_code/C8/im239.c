...
extern EIF_TYPED_VALUE F239_6886(EIF_REFERENCE);
extern void F239_7103(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F239_6886 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F239_7103 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 238, Current, 0, 7102);
	RTSA(dtype);
	RTME(dtype, 0);
