...
extern EIF_TYPED_VALUE F648_1939(EIF_REFERENCE);
extern EIF_TYPED_VALUE F648_1940(EIF_REFERENCE);
extern EIF_TYPED_VALUE F648_1941(EIF_REFERENCE);
extern void F648_1942(EIF_REFERENCE);
extern void F648_1943(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F648_1939 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 647, Current, 0, 0, 1914);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(647, Current, 1914);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F648_1940 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F648_1941 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 647, Current, 0, 0, 1916);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(647, Current, 1916);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F648_1942 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 647, Current, 0, 0, 1917);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(647, Current, 1917);
	RTIV(Current, RTAL);
...
void F648_1943 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 647, Current, 0, 0, 1918);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(647, Current, 1918);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
