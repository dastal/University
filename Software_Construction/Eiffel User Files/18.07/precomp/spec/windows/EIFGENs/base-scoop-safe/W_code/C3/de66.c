...
extern EIF_TYPED_VALUE F66_1430(EIF_REFERENCE);
extern EIF_TYPED_VALUE F66_1431(EIF_REFERENCE);
...
EIF_TYPED_VALUE F66_1430 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 65, Current, 0, 0, 1366);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(832, 30))(Current)).it_i4);
...
RTOID (F66_1431)
EIF_TYPED_VALUE F66_1431 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 65, Current, 0, 0, 1367);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
