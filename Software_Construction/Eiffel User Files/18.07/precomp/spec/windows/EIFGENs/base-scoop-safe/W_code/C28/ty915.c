...
extern EIF_TYPED_VALUE F915_3121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F915_3121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 914, Current, 0, 0, 3892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(914, Current, 3892);
	RTIV(Current, RTAL);
