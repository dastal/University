...
extern void F531_3537(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F531_3539(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F531_3540(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F531_3544(EIF_REFERENCE);
...
void F531_3537 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 530, Current, 1, 1, 6184);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(530, Current, 6184);
	RTIV(Current, RTAL);
...
void F531_3539 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 530, Current, 0, 1, 6185);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(530, Current, 6185);
...
body:;
	...
	for (;;) {
		...
		uc1 = tc1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2723, dtype))(Current, uc1x);
		RTHOOK(8);
...
void F531_3540 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 530, Current, 0, 1, 6186);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(530, Current, 6186);
	RTCC(arg1, 530, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F531_3544 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 530, Current, 0, 0, 6187);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(530, Current, 6187);
	RTIV(Current, RTAL);
	RTHOOK(1);
