...
extern EIF_TYPED_VALUE F703_3121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F703_3121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 702, Current, 0, 0, 3888);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(702, Current, 3888);
	RTIV(Current, RTAL);
