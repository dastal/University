...
extern EIF_TYPED_VALUE F831_3400(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F831_3401(EIF_REFERENCE);
extern EIF_TYPED_VALUE F831_3402(EIF_REFERENCE);
extern void F831_7066(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F831_3400 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 830, Current, 2, 1, 6148);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(830, Current, 6148);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						ti8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1771, "item", arg1))(arg1)).it_i8);
...
/* {LIST}.after */
EIF_TYPED_VALUE F831_3401 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 830, Current, 0, 0, 6149);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(830, Current, 6149);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F831_3402 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 830, Current, 0, 0, 6150);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(830, Current, 6150);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F831_7066 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 830, Current, 0, 7065);
	RTSA(dtype);
	RTME(dtype, 0);
