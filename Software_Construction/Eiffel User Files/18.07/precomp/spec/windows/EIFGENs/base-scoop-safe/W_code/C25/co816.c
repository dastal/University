...
extern EIF_TYPED_VALUE F816_1939(EIF_REFERENCE);
extern EIF_TYPED_VALUE F816_1940(EIF_REFERENCE);
extern EIF_TYPED_VALUE F816_1941(EIF_REFERENCE);
extern void F816_1942(EIF_REFERENCE);
extern void F816_1943(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F816_1939 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 815, Current, 0, 0, 1934);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(815, Current, 1934);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F816_1940 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F816_1941 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 815, Current, 0, 0, 1936);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(815, Current, 1936);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F816_1942 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 815, Current, 0, 0, 1937);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(815, Current, 1937);
	RTIV(Current, RTAL);
...
void F816_1943 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 815, Current, 0, 0, 1938);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(815, Current, 1938);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
