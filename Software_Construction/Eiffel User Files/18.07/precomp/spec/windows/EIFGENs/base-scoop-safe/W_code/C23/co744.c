...
extern EIF_TYPED_VALUE F744_1939(EIF_REFERENCE);
extern EIF_TYPED_VALUE F744_1940(EIF_REFERENCE);
extern EIF_TYPED_VALUE F744_1941(EIF_REFERENCE);
extern void F744_1942(EIF_REFERENCE);
extern void F744_1943(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F744_1939 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 743, Current, 0, 0, 1924);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(743, Current, 1924);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F744_1940 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F744_1941 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 743, Current, 0, 0, 1926);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(743, Current, 1926);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F744_1942 (EIF_REFERENCE Current)
{
	GTCX
...
void F744_1943 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 743, Current, 0, 0, 1928);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(743, Current, 1928);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
