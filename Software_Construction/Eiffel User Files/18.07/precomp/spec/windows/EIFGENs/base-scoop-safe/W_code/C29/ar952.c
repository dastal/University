...
extern void F952_4279(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F952_4280(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F952_4281(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F952_4282(EIF_REFERENCE);
extern EIF_TYPED_VALUE F952_4283(EIF_REFERENCE);
...
void F952_4279 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 951, Current, 0, 1, 9177);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(951, Current, 9177);
	RTCC(arg1, 951, l_feature_name, 1, RTWCT(1771, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {ARRAYED_STACK}.put */
void F952_4280 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 951, Current, 0, 1, 9178);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(951, Current, 9178);
	RTCC(arg1, 951, l_feature_name, 1, RTWCT(1771, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {ARRAYED_STACK}.force */
void F952_4281 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 951, Current, 0, 1, 9179);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(951, Current, 9179);
	RTCC(arg1, 951, l_feature_name, 1, RTWCT(1771, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F952_4282 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 951, Current, 0, 0, 9180);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(951, Current, 9180);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F952_4283 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 951, Current, 1, 0, 9181);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(951, Current, 9181);
	RTIV(Current, RTAL);
	RTHOOK(1);
