...
extern EIF_TYPED_VALUE F35_852(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F35_853(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F35_854(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F35_852 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 34, Current, 0, 1, 952);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(34, Current, 952);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F35_853 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 34, Current, 0, 1, 953);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(34, Current, 953);
	RTIV(Current, RTAL);
	{
...
void F35_854 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 34, Current, 0, 1, 954);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(34, Current, 954);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("an_id_non_negative", EX_PRE);
