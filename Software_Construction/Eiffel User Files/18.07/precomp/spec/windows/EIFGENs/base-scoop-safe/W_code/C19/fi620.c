...
extern EIF_TYPED_VALUE F620_2013(EIF_REFERENCE);
extern void F620_7036(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F620_2013 (EIF_REFERENCE Current)
{
	GTCX
...
/* {FINITE}._invariant */
void F620_7036 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 619, Current, 0, 7035);
	RTSA(dtype);
	RTME(dtype, 0);
