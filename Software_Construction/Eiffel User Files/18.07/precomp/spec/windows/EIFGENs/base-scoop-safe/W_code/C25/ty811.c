...
extern EIF_TYPED_VALUE F811_3121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F811_3121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 810, Current, 0, 0, 3891);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(810, Current, 3891);
	RTIV(Current, RTAL);
