...
extern EIF_TYPED_VALUE F450_3121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F450_3121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 449, Current, 0, 0, 3882);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(449, Current, 3882);
	RTIV(Current, RTAL);
