...
extern EIF_TYPED_VALUE F365_1939(EIF_REFERENCE);
extern EIF_TYPED_VALUE F365_1940(EIF_REFERENCE);
extern EIF_TYPED_VALUE F365_1941(EIF_REFERENCE);
extern void F365_1942(EIF_REFERENCE);
extern void F365_1943(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F365_1939 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 364, Current, 0, 0, 1884);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(364, Current, 1884);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F365_1940 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F365_1941 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 364, Current, 0, 0, 1886);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(364, Current, 1886);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F365_1942 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 364, Current, 0, 0, 1887);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(364, Current, 1887);
	RTIV(Current, RTAL);
...
void F365_1943 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 364, Current, 0, 0, 1888);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(364, Current, 1888);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
