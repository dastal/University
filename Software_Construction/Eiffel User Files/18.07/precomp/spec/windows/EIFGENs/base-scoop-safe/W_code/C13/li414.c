...
extern EIF_TYPED_VALUE F414_3400(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F414_3401(EIF_REFERENCE);
extern EIF_TYPED_VALUE F414_3402(EIF_REFERENCE);
extern void F414_7066(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F414_3400 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 413, Current, 2, 1, 6112);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(413, Current, 6112);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tp2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1771, "item", arg1))(arg1)).it_p);
...
/* {LIST}.after */
EIF_TYPED_VALUE F414_3401 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 413, Current, 0, 0, 6113);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(413, Current, 6113);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F414_3402 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 413, Current, 0, 0, 6114);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(413, Current, 6114);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F414_7066 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 413, Current, 0, 7065);
	RTSA(dtype);
	RTME(dtype, 0);
