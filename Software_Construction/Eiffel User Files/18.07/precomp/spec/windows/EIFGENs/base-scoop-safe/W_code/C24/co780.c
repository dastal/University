...
extern EIF_TYPED_VALUE F780_1939(EIF_REFERENCE);
extern EIF_TYPED_VALUE F780_1940(EIF_REFERENCE);
extern EIF_TYPED_VALUE F780_1941(EIF_REFERENCE);
extern void F780_1942(EIF_REFERENCE);
extern void F780_1943(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F780_1939 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 779, Current, 0, 0, 1929);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(779, Current, 1929);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F780_1940 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F780_1941 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 779, Current, 0, 0, 1931);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(779, Current, 1931);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F780_1942 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 779, Current, 0, 0, 1932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(779, Current, 1932);
	RTIV(Current, RTAL);
...
void F780_1943 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 779, Current, 0, 0, 1933);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(779, Current, 1933);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
