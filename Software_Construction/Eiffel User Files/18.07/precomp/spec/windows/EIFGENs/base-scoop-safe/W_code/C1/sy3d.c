...
static const EIF_TYPE_INDEX egt_0_3 [] = {0xFF01,231,0xFFFF};
static const EIF_TYPE_INDEX egt_1_3 [] = {0xFF01,246,2,0xFFFF};
...
static const EIF_TYPE_INDEX egt_9_3 [] = {0xFF01,231,0xFFFF};
static const EIF_TYPE_INDEX egt_10_3 [] = {0xFF01,231,0xFFFF};
...
static const struct desc_info desc_3[] = {
	...
	{EIF_NON_GENERIC(0x01B3 /*217*/), 36, 0xFFFFFFFF},
};
void Init3(void)
{
	IDSC(desc_3, 0, 2);
	IDSC(desc_3 + 1, 1, 2);
	IDSC(desc_3 + 32, 334, 2);
}
