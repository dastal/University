...
extern EIF_TYPED_VALUE F630_2027(EIF_REFERENCE);
extern void F630_7038(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F630_2027 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 629, Current, 0, 0, 2106);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(629, Current, 2106);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F630_7038 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 629, Current, 0, 7037);
	RTSA(dtype);
	RTME(dtype, 0);
