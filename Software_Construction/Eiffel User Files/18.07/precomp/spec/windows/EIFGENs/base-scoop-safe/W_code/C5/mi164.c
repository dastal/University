...
extern void F164_3987(EIF_REFERENCE);
extern EIF_TYPED_VALUE F164_3988(EIF_REFERENCE);
...
void F164_3987 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 163, Current, 2, 0, 7522);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(163, Current, 7522);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	RTDBGAL(Current, 2, 0xF800003E, 0, 0); /* loc2 */
	...
	RTHOOK(4);
	ur1 = RTCCL(loc1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1273, "raise_retrieval_exception", loc2))(loc2, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
RTOID (F164_3988)
EIF_TYPED_VALUE F164_3988 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 163, Current, 0, 0, 7523);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(163, Current, 7523);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
