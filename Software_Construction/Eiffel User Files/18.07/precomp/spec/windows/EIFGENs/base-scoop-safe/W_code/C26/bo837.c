...
extern EIF_TYPED_VALUE F837_2027(EIF_REFERENCE);
extern void F837_7038(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F837_2027 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 836, Current, 0, 0, 2116);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(836, Current, 2116);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F837_7038 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 836, Current, 0, 7037);
	RTSA(dtype);
	RTME(dtype, 0);
