...
extern EIF_TYPED_VALUE F902_3385(EIF_REFERENCE);
extern EIF_TYPED_VALUE F902_3386(EIF_REFERENCE);
extern void F902_3392(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F902_3395(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F902_3396(EIF_REFERENCE);
extern EIF_TYPED_VALUE F902_3397(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F902_3385 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 901, Current, 0, 0, 6088);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(901, Current, 6088);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F902_3386 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 901, Current, 0, 0, 6089);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(901, Current, 6089);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F902_3392 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 901, Current, 0, 1, 6090);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(901, Current, 6090);
	RTIV(Current, RTAL);
...
void F902_3395 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 901, Current, 0, 1, 6091);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(901, Current, 6091);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F902_3396 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 901, Current, 0, 0, 6092);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(901, Current, 6092);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F902_3397 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 901, Current, 2, 1, 6093);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(901, Current, 6093);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
