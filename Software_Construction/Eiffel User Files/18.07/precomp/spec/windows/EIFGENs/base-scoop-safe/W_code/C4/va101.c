...
EIF_TYPED_VALUE F101_1511 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 100, Current, 0, 0, 1447);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(818, 30))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 100, Current, 0, 0, 1448);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
