...
extern EIF_TYPED_VALUE F940_2027(EIF_REFERENCE);
extern void F940_7038(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F940_2027 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 939, Current, 0, 0, 2118);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(939, Current, 2118);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F940_7038 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 939, Current, 0, 7037);
	RTSA(dtype);
	RTME(dtype, 0);
