...
extern void F565_3040(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F565_3041(EIF_REFERENCE);
extern EIF_TYPED_VALUE F565_3042(EIF_REFERENCE);
extern EIF_TYPED_VALUE F565_3043(EIF_REFERENCE);
extern void F565_7057(EIF_REFERENCE, int);
...
void F565_3040 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 564, Current, 0, 3, 3790);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(564, Current, 3790);
	RTCC(arg1, 564, l_feature_name, 1, RTWCT(2521, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 2521, 0xF8000235, 0); /* active */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F565_3041 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F565_3042 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F565_3043 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F565_7057 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 564, Current, 0, 7056);
	RTSA(dtype);
	RTME(dtype, 0);
