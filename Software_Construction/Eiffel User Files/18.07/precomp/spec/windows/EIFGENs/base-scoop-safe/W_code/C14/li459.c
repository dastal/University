...
extern EIF_TYPED_VALUE F459_3400(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F459_3401(EIF_REFERENCE);
extern EIF_TYPED_VALUE F459_3402(EIF_REFERENCE);
extern void F459_7066(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F459_3400 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 458, Current, 2, 1, 6116);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(458, Current, 6116);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tr4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1771, "item", arg1))(arg1)).it_r4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F459_3401 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 458, Current, 0, 0, 6117);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(458, Current, 6117);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F459_3402 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 458, Current, 0, 0, 6118);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(458, Current, 6118);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F459_7066 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 458, Current, 0, 7065);
	RTSA(dtype);
	RTME(dtype, 0);
