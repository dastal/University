...
extern EIF_TYPED_VALUE F775_3121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F775_3121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 774, Current, 0, 0, 3890);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(774, Current, 3890);
	RTIV(Current, RTAL);
