...
extern EIF_TYPED_VALUE F392_1939(EIF_REFERENCE);
extern EIF_TYPED_VALUE F392_1940(EIF_REFERENCE);
extern EIF_TYPED_VALUE F392_1941(EIF_REFERENCE);
extern void F392_1942(EIF_REFERENCE);
extern void F392_1943(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F392_1939 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 391, Current, 0, 0, 1889);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(391, Current, 1889);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F392_1940 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F392_1941 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 391, Current, 0, 0, 1891);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(391, Current, 1891);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F392_1942 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 391, Current, 0, 0, 1892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(391, Current, 1892);
	RTIV(Current, RTAL);
...
void F392_1943 (EIF_REFERENCE Current)
{
	GTCX
