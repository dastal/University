...
extern EIF_TYPED_VALUE F739_3121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F739_3121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 738, Current, 0, 0, 3889);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(738, Current, 3889);
	RTIV(Current, RTAL);
