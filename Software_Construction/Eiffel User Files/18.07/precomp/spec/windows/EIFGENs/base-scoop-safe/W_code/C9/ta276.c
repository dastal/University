...
extern void F276_1998(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F276_1998 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 275, Current, 0, 1, 1990);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(275, Current, 1990);
	RTCC(arg1, 275, l_feature_name, 1, RTWCT(1730, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
