...
extern EIF_TYPED_VALUE F405_3121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F405_3121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 404, Current, 0, 0, 3881);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(404, Current, 3881);
	RTIV(Current, RTAL);
