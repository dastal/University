...
extern void F11_7013(EIF_REFERENCE, int);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(91, dtype)) = (EIF_INTEGER_32) arg1;
	...
	ui4_1 = ti4_1;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2153, "field_count_of_type", tr1))(tr1, ui4_1x)).it_i4);
	loc1 = (EIF_INTEGER_32) ti4_1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 96, 0xF80001FA, 0); /* mismatches_by_name */
	...
	*(EIF_REFERENCE *)(Current + RTWA(96, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 97, 0xF80000F4, 0); /* mismatches_by_stored_position */
...
#define up1 up1x.it_p
	...
	if (arg1) {
		RTCC(arg1, 10, l_feature_name, 1, eif_new_type(239, 0x00), 0x00);
	}
	if (arg2) {
		RTCC(arg2, 10, l_feature_name, 2, eif_new_type(239, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 94, 0xF80000EF, 0); /* old_version */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(94, dtype)) = (EIF_REFERENCE) arg1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 95, 0xF80000EF, 0); /* new_version */
	RTAR(Current, arg2);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTCC(arg3, 10, l_feature_name, 3, eif_new_type(231, 0x01), 0x01);
	RTCC(arg4, 10, l_feature_name, 4, eif_new_type(231, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,0xFFF9,9,185,0xFF01,231,0xFF01,231,217,217,217,217,202,202,202,0xFFFF};
		EIF_TYPE typres0;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTCC(arg2, 10, l_feature_name, 2, eif_new_type(231, 0x01), 0x01);
	RTCC(arg3, 10, l_feature_name, 3, eif_new_type(231, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F11_7013 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 10, Current, 0, 7012);
	RTSA(dtype);
	RTME(dtype, 0);
