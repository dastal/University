...
extern EIF_TYPED_VALUE F795_3400(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F795_3401(EIF_REFERENCE);
extern EIF_TYPED_VALUE F795_3402(EIF_REFERENCE);
extern void F795_7066(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F795_3400 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 794, Current, 2, 1, 6144);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(794, Current, 6144);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1771, "item", arg1))(arg1)).it_n8);
...
/* {LIST}.after */
EIF_TYPED_VALUE F795_3401 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 794, Current, 0, 0, 6145);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(794, Current, 6145);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F795_3402 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 794, Current, 0, 0, 6146);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(794, Current, 6146);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F795_7066 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 794, Current, 0, 7065);
	RTSA(dtype);
	RTME(dtype, 0);
