...
extern EIF_TYPED_VALUE F661_3121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F661_3121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 660, Current, 0, 0, 3887);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(660, Current, 3887);
	RTIV(Current, RTAL);
