...
extern EIF_TYPED_VALUE F486_3121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F486_3121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 485, Current, 0, 0, 3883);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(485, Current, 3883);
	RTIV(Current, RTAL);
