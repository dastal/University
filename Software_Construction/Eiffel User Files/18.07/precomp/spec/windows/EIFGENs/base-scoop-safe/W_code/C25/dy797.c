...
extern EIF_TYPED_VALUE F797_3385(EIF_REFERENCE);
extern EIF_TYPED_VALUE F797_3386(EIF_REFERENCE);
extern void F797_3392(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F797_3395(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F797_3396(EIF_REFERENCE);
extern EIF_TYPED_VALUE F797_3397(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F797_3385 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 796, Current, 0, 0, 6076);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(796, Current, 6076);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F797_3386 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 796, Current, 0, 0, 6077);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(796, Current, 6077);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F797_3392 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 796, Current, 0, 1, 6078);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(796, Current, 6078);
	RTIV(Current, RTAL);
...
void F797_3395 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 796, Current, 0, 1, 6079);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(796, Current, 6079);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F797_3396 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 796, Current, 0, 0, 6080);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(796, Current, 6080);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F797_3397 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 796, Current, 2, 1, 6081);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(796, Current, 6081);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		uu8_1 = tu8_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1735, "extend", Result))(Result, uu8_1x);
		RTHOOK(9);
