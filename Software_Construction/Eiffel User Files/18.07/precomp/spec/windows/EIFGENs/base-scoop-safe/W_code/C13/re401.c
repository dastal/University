...
extern EIF_TYPED_VALUE F401_3216(EIF_REFERENCE);
extern EIF_TYPED_VALUE F401_3219(EIF_REFERENCE);
extern void F401_7061(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F401_3216 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 400, Current, 0, 0, 4817);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(400, Current, 4817);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F401_3219 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 400, Current, 0, 0, 4819);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(400, Current, 4819);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F401_7061 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 400, Current, 0, 7060);
	RTSA(dtype);
	RTME(dtype, 0);
