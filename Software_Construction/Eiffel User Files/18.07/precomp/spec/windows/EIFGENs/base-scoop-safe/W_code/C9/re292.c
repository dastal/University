...
extern EIF_TYPED_VALUE F292_3216(EIF_REFERENCE);
extern EIF_TYPED_VALUE F292_3219(EIF_REFERENCE);
extern void F292_7061(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F292_3216 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F292_3219 (EIF_REFERENCE Current)
{
	GTCX
...
void F292_7061 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 291, Current, 0, 7060);
	RTSA(dtype);
	RTME(dtype, 0);
