...
extern EIF_TYPED_VALUE F560_3121(EIF_REFERENCE);
...
EIF_TYPED_VALUE F560_3121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 559, Current, 0, 0, 3885);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(559, Current, 3885);
	RTIV(Current, RTAL);
