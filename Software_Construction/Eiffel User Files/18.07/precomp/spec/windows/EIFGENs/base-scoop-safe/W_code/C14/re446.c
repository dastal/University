...
extern EIF_TYPED_VALUE F446_3216(EIF_REFERENCE);
extern EIF_TYPED_VALUE F446_3219(EIF_REFERENCE);
extern void F446_7061(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F446_3216 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 445, Current, 0, 0, 4820);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F446_3219 (EIF_REFERENCE Current)
{
	GTCX
...
void F446_7061 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 445, Current, 0, 7060);
	RTSA(dtype);
	RTME(dtype, 0);
