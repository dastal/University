...
extern void F669_3537(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F669_3539(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F669_3540(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F669_3544(EIF_REFERENCE);
...
void F669_3537 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 668, Current, 1, 1, 6192);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(668, Current, 6192);
	RTIV(Current, RTAL);
...
void F669_3539 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 668, Current, 0, 1, 6193);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(668, Current, 6193);
...
body:;
	...
	for (;;) {
		...
		ub1 = tb2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2723, dtype))(Current, ub1x);
		RTHOOK(8);
...
void F669_3540 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 668, Current, 0, 1, 6194);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(668, Current, 6194);
	RTCC(arg1, 668, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F669_3544 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 668, Current, 0, 0, 6195);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(668, Current, 6195);
	RTIV(Current, RTAL);
	RTHOOK(1);
