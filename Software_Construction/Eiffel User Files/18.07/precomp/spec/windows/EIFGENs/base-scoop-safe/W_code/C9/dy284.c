...
extern void F284_3537(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F284_3539(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F284_3540(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F284_3544(EIF_REFERENCE);
...
void F284_3537 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 283, Current, 1, 1, 6160);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(283, Current, 6160);
	RTCC(arg1, 283, l_feature_name, 1, RTWCT(1771, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F284_3539 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 283, Current, 0, 1, 6161);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(283, Current, 6161);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tr5 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1771, "item", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr5);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2723, dtype))(Current, ur1x);
		RTHOOK(8);
...
void F284_3540 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 283, Current, 0, 1, 6162);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(283, Current, 6162);
	RTCC(arg1, 283, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F284_3544 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 283, Current, 0, 0, 6163);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(283, Current, 6163);
	RTIV(Current, RTAL);
	RTHOOK(1);
