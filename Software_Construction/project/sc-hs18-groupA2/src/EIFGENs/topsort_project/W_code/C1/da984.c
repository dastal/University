...
extern void F984_8457(EIF_REFERENCE, int);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 983, Current, 0, 0, 13700);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F984_8457 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 983, Current, 0, 8456);
	RTSA(dtype);
	RTME(dtype, 0);
