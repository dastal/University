...
extern void F981_7413(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F981_7414(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 980, Current, 0, 0, 13677);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(980, Current, 13677);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 980, Current, 0, 0, 13678);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(980, Current, 13678);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5228, dtype));
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 980, Current, 0, 0, 13679);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(980, Current, 13679);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5228, dtype));
...
EIF_TYPED_VALUE F981_7409 (EIF_REFERENCE Current)
{
	...
	Result = *(EIF_REAL_64 *)(Current + RTWA(5227, dtype));
...
EIF_TYPED_VALUE F981_7410 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 980, Current, 0, 0, 13664);
	RTSA(Dtype(Current));
	RTSC;
	...
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(5227, Dtype(Current)));
...
/* {TIME_VALUE}.set_hour */
void F981_7413 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
void F981_7414 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r8
	...
	RTEAA(l_feature_name, 980, Current, 0, 1, 13671);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
