...
extern void F989_7467(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 988, Current, 1, 0, 13712);
	RTSA(Dtype(Current));
	RTSC;
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5278, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 988, Current, 0, 0, 13714);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
void F989_7467 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 988, Current, 0, 1, 13715);
	RTSA(Dtype(Current));
	RTSC;
