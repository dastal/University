...
extern void F963_7172(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F963_7173(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F963_7174(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F963_7175(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F963_7172 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 962, Current, 1, 2, 13458);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5007, 0x04000000, 1); /* last_assertion_failed */
	*(EIF_BOOLEAN *)(Current + RTWA(5007, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) !arg2;
	RTHOOK(3);
...
void F963_7173 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 962, Current, 0, 2, 13459);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5003, dtype))(Current, ur1x, ub1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
void F963_7174 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 962, Current, 0, 1, 13460);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F963_7175 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 962, Current, 0, 1, 13461);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
