...
static const struct desc_info desc_970[] = {
	...
	{EIF_GENERIC(egt_13_970), 13605, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_970), 13606, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_970), 13607, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_970), 13608, 0xFFFFFFFF},
	{EIF_GENERIC(egt_17_970), 13609, 0xFFFFFFFF},
	{EIF_GENERIC(egt_18_970), 13612, 0xFFFFFFFF},
	{EIF_GENERIC(egt_19_970), 13610, 0xFFFFFFFF},
	{EIF_GENERIC(egt_20_970), 13611, 0xFFFFFFFF},
};
void Init970(void)
{
	IDSC(desc_970, 0, 969);
	IDSC(desc_970 + 1, 1, 969);
	IDSC(desc_970 + 32, 434, 969);
}
