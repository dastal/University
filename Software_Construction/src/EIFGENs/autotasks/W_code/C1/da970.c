...
extern EIF_TYPED_VALUE F970_7304(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F970_7297,13606,RTMS_EX_H("English",7,257590376));
}
...
{
	GTCX
	RTOTC (F970_7302,13611,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F970_7303,13612,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F970_7304 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F970_7304,13613,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit970 (void)
{
	GTCX
	RTOTS (7297,F970_7297)
	RTOTS (7298,F970_7298)
	RTOTS (7299,F970_7299)
	RTOTS (7300,F970_7300)
	RTOTS (7301,F970_7301)
	RTOTS (7302,F970_7302)
	RTOTS (7303,F970_7303)
	RTOTS (7304,F970_7304)
}
