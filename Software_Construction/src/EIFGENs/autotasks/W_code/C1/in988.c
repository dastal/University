...
extern EIF_TYPED_VALUE F988_7450(EIF_REFERENCE);
extern EIF_TYPED_VALUE F988_7451(EIF_REFERENCE);
extern EIF_TYPED_VALUE F988_7452(EIF_REFERENCE);
extern void F988_7453(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F988_7450 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 987, Current, 1, 0, 13726);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(987, Current, 13726);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5266, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F988_7451)
EIF_TYPED_VALUE F988_7451 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F988_7452 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 987, Current, 0, 0, 13728);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(987, Current, 13728);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80003DF, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(993, 0x01).id);
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 987, Current, 0, 1, 13729);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(987, Current, 13729);
