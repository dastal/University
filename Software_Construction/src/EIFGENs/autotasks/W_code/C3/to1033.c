/*
 * Code for class TOPSORT [INTEGER_32]
 */
...
extern void F1033_7182(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1033_7183(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1033_7184(EIF_REFERENCE);
extern void F1033_7185(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1033_7186(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1033_7187(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1033_7188(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1033_7189(EIF_REFERENCE);
...
/* {TOPSORT}.make */
void F1033_7182 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1032, Current, 0, 0, 13468);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1032, Current, 13468);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5014, 0xF8000233, 0); /* sorted_list */
	...
	*(EIF_REFERENCE *)(Current + RTWA(5014, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5015, 0xF8000233, 0); /* circle */
...
/* {TOPSORT}.sorted_list */
EIF_TYPED_VALUE F1033_7183 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {TOPSORT}.circle */
EIF_TYPED_VALUE F1033_7184 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1033_7185 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1032, Current, 1, 1, 13471);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1032, Current, 13471);
	{
...
/* {TOPSORT}.topsort */
void F1033_7186 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1032, Current, 17, 2, 13472);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1032, Current, 13472);
	{
	...
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,851,0xFF01,563,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(5021, dtype, dftype);
...
body:;
	...
	RTHOOK(6);
	RTDBGAL(Current, 4, 0xF8000233, 0, 0); /* loc4 */
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,563,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
	...
	RTHOOK(7);
	RTDBGAL(Current, 5, 0xF8000233, 0, 0); /* loc5 */
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,563,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
	...
	RTHOOK(9);
	RTDBGAL(Current, 7, 0xF8000233, 0, 0); /* loc7 */
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,563,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
	...
	RTHOOK(10);
	RTDBGAL(Current, 8, 0xF8000233, 0, 0); /* loc8 */
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,563,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
	...
	for (;;) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1771, "item", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(17,3);
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2693, "last", tr1))(tr1)).it_i4);
		ui4_1 = ti4_2;
		tb2 = ti4_1 == ui4_1;
		if (tb2) {
			RTHOOK(18);
	...
	for (;;) {
		...
		if (tb2) break;
		RTHOOK(24);
		RTDBGAL(Current, 1, 0xF8000237, 0, 0); /* loc10 */
		...
		for (;;) {
			...
			RTNHOOK(25,2);
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1700, "item", loc10))(loc10)).it_i4);
			ui4_1 = ti4_2;
			tb4 = ti4_1 == ui4_1;
			if (tb4) {
				RTHOOK(26);
	...
	for (;;) {
		...
		if (tb4) break;
		RTHOOK(37);
		RTDBGAL(Current, 2, 0xF8000237, 0, 0); /* loc11 */
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2525, "new_cursor", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		...
		for (;;) {
			...
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2692, "first", tr1))(tr1)).it_i4);
			RTNHOOK(38,2);
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1700, "item", loc11))(loc11)).it_i4);
			ui4_1 = ti4_2;
			tb6 = ti4_1 == ui4_1;
			if (tb6) {
				RTHOOK(39);
	...
	for (;;) {
		...
		if (tb6) break;
		RTHOOK(50);
		RTDBGAL(Current, 3, 0xF8000237, 0, 0); /* loc12 */
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2525, "new_cursor", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		...
		for (;;) {
			...
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2693, "last", tr1))(tr1)).it_i4);
			RTNHOOK(51,2);
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1700, "item", loc12))(loc12)).it_i4);
			ui4_1 = ti4_2;
			tb8 = ti4_1 == ui4_1;
			if (tb8) {
				RTHOOK(52);
				...
				RTHOOK(53);
				ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1700, "item", loc12))(loc12)).it_i4);
				ui4_1 = ti4_1;
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1737, "prune", loc3))(loc3, ui4_1x);
				RTHOOK(54);
				(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(1804, "start", loc3))(loc3);
			}
			RTHOOK(55);
	...
	for (;;) {
		...
		for (;;) {
			...
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2692, "first", tr1))(tr1)).it_i4);
			RTNHOOK(61,2);
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1771, "item", loc4))(loc4)).it_i4);
			ui4_1 = ti4_2;
			tb10 = ti4_1 == ui4_1;
			if (tb10) {
				RTHOOK(62);
				...
				for (;;) {
					...
					RTNHOOK(63,3);
					ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2692, "first", tr1))(tr1)).it_i4);
					ui4_1 = ti4_2;
					tb11 = ti4_1 == ui4_1;
				...
				RTHOOK(67);
				RTDBGAL(Current, 6, 0xF8000237, 0, 0); /* loc15 */
				...
				for (;;) {
					...
					if (tb11) break;
					RTHOOK(68);
					ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1700, "item", loc15))(loc15)).it_i4);
					RTNHOOK(68,1);
					tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1700, "item", loc13))(loc13)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
					RTNHOOK(68,2);
					ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2693, "last", tr1))(tr1)).it_i4);
				...
				if ((EIF_BOOLEAN)(loc9 == (EIF_BOOLEAN) 0)) {
					...
					ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2693, "last", tr1))(tr1)).it_i4);
					ui4_1 = ti4_1;
					(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1735, "extend", loc4))(loc4, ui4_1x);
				} else {
					RTHOOK(73);
					RTDBGAL(Current, 9, 0x04000000, 1, 0); /* loc9 */
					loc9 = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
		...
		RTHOOK(83);
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1771, "item", loc4))(loc4)).it_i4);
		ui4_1 = ti4_1;
	...
	RTHOOK(85);
	RTDBGAL(Current, 7, 0xF8000237, 0, 0); /* loc16 */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2525, "new_cursor", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	...
	for (;;) {
		...
		if (tb13) break;
		RTHOOK(86);
		RTDBGAL(Current, 8, 0xF8000237, 0, 0); /* loc17 */
		...
		for (;;) {
			...
			if (tb14) break;
			RTHOOK(87);
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1700, "item", loc16))(loc16)).it_i4);
			RTNHOOK(87,1);
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1700, "item", loc17))(loc17)).it_i4);
			ui4_1 = ti4_2;
			tb15 = ti4_1 == ui4_1;
			if (tb15) {
				RTHOOK(88);
		...
		if ((EIF_BOOLEAN)(loc9 == (EIF_BOOLEAN) 0)) {
			...
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1700, "item", loc16))(loc16)).it_i4);
			ui4_1 = ti4_1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1735, "extend", loc8))(loc8, ui4_1x);
		} else {
			RTHOOK(92);
			RTDBGAL(Current, 9, 0x04000000, 1, 0); /* loc9 */
			loc9 = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
...
/* {TOPSORT}.print_next */
void F1033_7187 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1032, Current, 2, 1, 13473);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1032, Current, 13473);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,563,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
...
/* {TOPSORT}.print_copys */
void F1033_7188 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1032, Current, 3, 1, 13474);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1032, Current, 13474);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,851,0xFF01,563,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
...
/* {TOPSORT}.get_cycles */
EIF_TYPED_VALUE F1033_7189 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1032, Current, 0, 0, 13475);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1032, Current, 13475);
	RTIV(Current, RTAL);
	RTHOOK(1);
